...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.CommonVehicleModel, splc.domain in the schema.
    /// </summary>
    public partial class CommonVehicleModel : IKeyed<int>
    {
