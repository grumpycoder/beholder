...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderCorrespondenceType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderCorrespondenceType : IKeyed<int>
    {
        ...
        public BeholderCorrespondenceType()
        {
            OnCreated();
        }
