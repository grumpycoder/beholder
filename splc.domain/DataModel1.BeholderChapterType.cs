...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderChapterType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderChapterType : IKeyed<int>
    {
