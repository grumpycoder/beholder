...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderAudioVideoType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderAudioVideoType : IKeyed<int>
    {
