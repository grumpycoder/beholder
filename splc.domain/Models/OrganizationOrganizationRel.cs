...
{
    public partial class OrganizationOrganizationRel
    {
        [Key]
        ...
        [Display(Name = "Organization")]
        [NotEqualTo("OrganizationId", PassOnNull = true, ErrorMessage = "Unable to add relationship to itself")]
        public int Organization2Id { get; set; }
