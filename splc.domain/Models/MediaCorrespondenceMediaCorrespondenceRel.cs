...
{
    public partial class MediaCorrespondenceMediaCorrespondenceRel
    {
        [Key]
        ...
        [Display(Name = "Correspondence")]
        [NotEqualTo("MediaCorrespondenceId", PassOnNull = true, ErrorMessage = "Unable to add relationship to itself")]
        public int MediaCorrespondence2Id { get; set; }
        ...
        [Display(Name = "Correspondence")]
        public virtual MediaCorrespondence MediaCorrespondence2 { get; set; }
        [Display(Name = "Primary Status")]
