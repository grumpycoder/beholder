...
{
    public partial class PersonPersonRel
    {
        [Key]
        ...
        [Display(Name = "Person")]
        [NotEqualTo("PersonId", PassOnNull = true, ErrorMessage = "Unable to add relationship to itself")]
        ...
        [Display(Name = "Person")]
        public virtual BeholderPerson BeholderPerson2 { get; set; }
        [Display(Name = "Primary Status")]
