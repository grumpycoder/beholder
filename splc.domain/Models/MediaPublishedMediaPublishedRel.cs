...
{
    public partial class MediaPublishedMediaPublishedRel
    {
        [Key]
        ...
        [Display(Name = "Published")]
        [NotEqualTo("MediaPublishedId", PassOnNull = true, ErrorMessage = "Unable to add relationship to itself")]
        public int MediaPublished2Id { get; set; }
        ...
        [Display(Name = "Published")]
        public virtual MediaPublished MediaPublished2 { get; set; }
        [Display(Name = "Primary Status")]
