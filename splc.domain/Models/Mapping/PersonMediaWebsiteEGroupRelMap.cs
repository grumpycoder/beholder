...
{
    public class PersonMediaWebsiteEGroupRelMap : EntityTypeConfiguration<PersonMediaWebsiteEGroupRel>
    {
        public PersonMediaWebsiteEGroupRelMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("PersonMediaWebsiteEGroupRel", "Beholder");
            ...
            this.HasOptional(t => t.ApprovalStatus)
                .WithMany(t => t.PersonMediaWebsiteEGroupRels)
