...
{
    public class MediaCorrespondenceVehicleRelMap : EntityTypeConfiguration<MediaCorrespondenceVehicleRel>
    {
        public MediaCorrespondenceVehicleRelMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("MediaCorrespondenceVehicleRel", "Beholder");
            ...
            this.HasOptional(t => t.ApprovalStatus)
                .WithMany(t => t.MediaCorrespondenceVehicleRels)
