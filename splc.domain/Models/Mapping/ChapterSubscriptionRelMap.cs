...
{
    public class ChapterSubscriptionRelMap : EntityTypeConfiguration<ChapterSubscriptionRel>
    {
        public ChapterSubscriptionRelMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("ChapterSubscriptionRel", "Beholder");
            ...
            this.HasOptional(t => t.ApprovalStatus)
                .WithMany(t => t.ChapterSubscriptionRels)
