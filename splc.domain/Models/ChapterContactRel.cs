...
{
    public partial class ChapterContactRel
    {
        [Key]
        ...
        [Remote("ChapterHasPrimaryContact", "Validation", AdditionalFields = "Id, ChapterId", ErrorMessage = "Chapter already has primary contact.", HttpMethod = "POST")]
