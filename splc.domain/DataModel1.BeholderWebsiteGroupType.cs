...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderWebsiteGroupType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderWebsiteGroupType : IKeyed<int>
    {
        ...
        public BeholderWebsiteGroupType()
        {
            OnCreated();
        }
