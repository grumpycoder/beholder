...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.CommonLicenseType, splc.domain in the schema.
    /// </summary>
    public partial class CommonLicenseType : IKeyed<int>
    {
