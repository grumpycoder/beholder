...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderAddressCompanyRel, splc.domain in the schema.
    /// </summary>
    public partial class BeholderAddressCompanyRel : IKeyed<int>
    {
        ...
        public BeholderAddressCompanyRel()
        {
            OnCreated();
        }
