...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderMovementClass, splc.domain in the schema.
    /// </summary>
    public partial class BeholderMovementClass : IKeyed<int>
    {
