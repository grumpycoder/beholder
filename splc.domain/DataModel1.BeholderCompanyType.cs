...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderCompanyType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderCompanyType : IKeyed<int>
    {
