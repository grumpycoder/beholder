...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderNewsSourceType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderNewsSourceType : IKeyed<int>
    {
