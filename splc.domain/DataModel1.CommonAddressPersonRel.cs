...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.CommonAddressPersonRel, splc.domain in the schema.
    /// </summary>
    public partial class CommonAddressPersonRel : IKeyed<int>
    {
        ...
        public virtual CommonAddressType CommonAddressType
        {
            get
            {
                return this._CommonAddressType ?? new CommonAddressType();
            }
            set
            {
