...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.CommonVehicleColor, splc.domain in the schema.
    /// </summary>
    public partial class CommonVehicleColor : IKeyed<int>
    {
