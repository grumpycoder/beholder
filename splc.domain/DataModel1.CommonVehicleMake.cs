...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.CommonVehicleMake, splc.domain in the schema.
    /// </summary>
    public partial class CommonVehicleMake : IKeyed<int>
    {
        ...
        private Iesi.Collections.ISet _BeholderVehicles;

        private Iesi.Collections.ISet _CommonVehicleModels;
        ...
        public CommonVehicleMake()
        {
            this._BeholderVehicles = new Iesi.Collections.HashedSet();
            this._CommonVehicleModels = new Iesi.Collections.HashedSet();
            OnCreated();
        }
        ...
        /// <summary>
        /// There are no comments for BeholderVehicles in the schema.
        /// </summary>
        public virtual Iesi.Collections.ISet BeholderVehicles
        {
            get
            {
                return this._BeholderVehicles;
            }
            set
            {
                this._BeholderVehicles = value;
            }
        }

    
        /// <summary>
        /// There are no comments for CommonVehicleModels in the schema.
        /// </summary>
        public virtual Iesi.Collections.ISet CommonVehicleModels
        {
            get
            {
                return this._CommonVehicleModels;
            }
            set
            {
                this._CommonVehicleModels = value;
            }
        }
