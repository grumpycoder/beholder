...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.CommonVehicleType, splc.domain in the schema.
    /// </summary>
    public partial class CommonVehicleType : IKeyed<int>
    {
