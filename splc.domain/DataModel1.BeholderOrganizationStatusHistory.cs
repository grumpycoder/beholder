...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderOrganizationStatusHistory, splc.domain in the schema.
    /// </summary>
    public partial class BeholderOrganizationStatusHistory : IKeyed<int>
    {
        ...
        public BeholderOrganizationStatusHistory()
        {
            OnCreated();
        }
