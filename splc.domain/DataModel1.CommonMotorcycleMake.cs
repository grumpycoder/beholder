...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.CommonMotorcycleMake, splc.domain in the schema.
    /// </summary>
    public partial class CommonMotorcycleMake : IKeyed<int>
    {
        ...
        private Iesi.Collections.ISet _CommonMotorcycleModels;
        ...
        public CommonMotorcycleMake()
        {
            this._CommonMotorcycleModels = new Iesi.Collections.HashedSet();
            OnCreated();
        }
        ...
        /// <summary>
        /// There are no comments for CommonMotorcycleModels in the schema.
        /// </summary>
        public virtual Iesi.Collections.ISet CommonMotorcycleModels
        {
            get
            {
                return this._CommonMotorcycleModels;
            }
            set
            {
                this._CommonMotorcycleModels = value;
            }
        }
