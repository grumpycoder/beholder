...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderMediaType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderMediaType : IKeyed<int>
    {
