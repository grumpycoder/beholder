...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderActiveStatus, splc.domain in the schema.
    /// </summary>
    public partial class BeholderActiveStatus : IKeyed<int> {
        ...
        private Iesi.Collections.ISet _BeholderSubscriptions;
        ...
        public BeholderActiveStatus()
        {
            this._BeholderOrganizationStatusHistories = new Iesi.Collections.HashedSet();
            this._BeholderSubscriptions = new Iesi.Collections.HashedSet();
        ...
        /// <summary>
        /// There are no comments for BeholderSubscriptions in the schema.
        /// </summary>
        public virtual Iesi.Collections.ISet BeholderSubscriptions
        {
            get
            {
                return this._BeholderSubscriptions;
            }
            set
            {
                this._BeholderSubscriptions = value;
            }
        }
