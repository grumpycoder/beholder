...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderImageType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderImageType : IKeyed<int>
    {
