...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderContactType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderContactType : IKeyed<int>
    {
