...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderRenewalPermmisionType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderRenewalPermmisionType : IKeyed<int>
    {
        ...
        public BeholderRenewalPermmisionType()
        {
            OnCreated();
        }
