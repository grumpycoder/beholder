...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderObjectType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderObjectType : IKeyed<int>
    {
