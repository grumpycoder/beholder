...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderAddressChapterRel, splc.domain in the schema.
    /// </summary>
    public partial class BeholderAddressChapterRel : IKeyed<int>
    {
        ...
        public BeholderAddressChapterRel()
        {
            OnCreated();
        }
