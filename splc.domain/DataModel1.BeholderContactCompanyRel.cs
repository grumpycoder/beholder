...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderContactCompanyRel, splc.domain in the schema.
    /// </summary>
    public partial class BeholderContactCompanyRel : IKeyed<int>
    {
        ...
        public BeholderContactCompanyRel()
        {
            OnCreated();
        }
