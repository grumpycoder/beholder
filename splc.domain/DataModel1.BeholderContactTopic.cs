...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderContactTopic, splc.domain in the schema.
    /// </summary>
    public partial class BeholderContactTopic : IKeyed<int>
    {
