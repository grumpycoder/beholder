...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderApprovalStatus, splc.domain in the schema.
    /// </summary>
    public partial class BeholderApprovalStatus : IKeyed<int>
    {
