...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.CommonCompanyType, splc.domain in the schema.
    /// </summary>
    public partial class CommonCompanyType : IKeyed<int>
    {
