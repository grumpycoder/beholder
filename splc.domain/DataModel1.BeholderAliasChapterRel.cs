...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderAliasChapterRel, splc.domain in the schema.
    /// </summary>
    public partial class BeholderAliasChapterRel : IKeyed<int>
    {
        ...
        public BeholderAliasChapterRel()
        {
            OnCreated();
        }
