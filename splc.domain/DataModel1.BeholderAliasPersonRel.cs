...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderAliasPersonRel, splc.domain in the schema.
    /// </summary>
    public partial class BeholderAliasPersonRel : IKeyed<int>
    {
