...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.SecurityUserType, splc.domain in the schema.
    /// </summary>
    public partial class SecurityUserType : IKeyed<int>
    {
        ...
        private Iesi.Collections.ISet _SecurityUsers_UserTypeId;
        ...
        public SecurityUserType()
        {
            this._SecurityUsers_UserTypeId = new Iesi.Collections.HashedSet();
            OnCreated();
        }
        ...
        /// <summary>
        /// There are no comments for SecurityUsers_UserTypeId in the schema.
        /// </summary>
        public virtual Iesi.Collections.ISet SecurityUsers_UserTypeId
        {
            get
            {
                return this._SecurityUsers_UserTypeId;
            }
            set
            {
                this._SecurityUsers_UserTypeId = value;
            }
        }
    }
