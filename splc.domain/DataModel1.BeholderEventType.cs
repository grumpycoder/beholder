...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderEventType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderEventType : IKeyed<int>
    {
