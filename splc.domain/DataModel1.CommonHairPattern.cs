...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.CommonHairPattern, splc.domain in the schema.
    /// </summary>
    public partial class CommonHairPattern : IKeyed<int>
    {
