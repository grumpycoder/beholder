...
namespace splc.domain
{
    ...
    /// <summary>
    /// There are no comments for splc.domain.BeholderPublishedType, splc.domain in the schema.
    /// </summary>
    public partial class BeholderPublishedType : IKeyed<int>
    {
