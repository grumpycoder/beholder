...
$(function () {
    ...
    //$('.datePicker').on('click', function () { $(this).datepicker('destroy').datepicker({ showOn: 'focus' }).focus(); });
...
function initControls() {
                      ...
                      $.ajax({
                          ...
                          success: function (data) {
                              if (data.length == 0) {
                                  ...
                                  //$(this).val("");
                                  //$(this).delay(function () {
                                  //    $(this).tooltip().tooltip("close").attr("title", "");
                                  //}, 2500);
    ...
    $('#slider').movingBoxes({
        startPanel: 1,      // start with first page of the flyer
...
(function ($) {
    ...
    //$.validator.unobtrusive.adapters.add('futuredate', ['min', 'max', 'dateseperator'], function(options) {
    //    var params = {
    //        min: options.params.min,
    //        max: options.params.max,
    //        seperator: options.params.seperator.dateseperator
    //    };
    //    options.rules['futuredate'] = params;
    //    if (options.message) {
    //        options.messages['futuredate'] = options.messages;
    //    }
    //});
...
function initPartialControls() {
    ...
    $("#combobox_contacts").combobox();
    $("#combobox_sub").combobox();
    $("#combobox_website").combobox();
    $("#combobox_subscription").combobox();
    $("#combobox_con").combobox();
